...
module.exports = {
    ...
    output: {
        path: path.resolve(__dirname, './UniversalPayment'), //打包后的js文件存放的地方
        filename: '[name].[chunkhash:8].js', //打包后输出的js的文件名
        publicPath: '/rongxin/test/UniversalPayment/', //公共路径在页面或者css引入图片需要这个路劲
    ...
    plugins: [
        ...
        new CleanWebpackPlugin(['UniversalPayment']), //清理WebShop文件夹下无用的文件
